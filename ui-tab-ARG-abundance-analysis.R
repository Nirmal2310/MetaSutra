              ...
              tabPanel(title = "ARGs Richness",
                       tabsetPanel(id="Richness_per_group",
                         tabPanel(title = "Control Richness",
                                  ...
                                  plotOutput("plot_control_circular_richness_plot", height = "auto", width = "auto")
                         ...
                         tabPanel(title = "Case Richness",
                                  ...
                                  plotOutput("plot_case_circular_richness_plot", height = "auto", width = "auto")
                                )
                       )
                       ),
              tabPanel("ARGs Abundance",
                       tabsetPanel(id="Abundance_per_group",
                                   tabPanel(title = "Control Abundance",
                                            ...
                                            plotOutput("plot_control_abundance_heatmap", height = "auto", width = "auto")
                                   ...
                                   tabPanel(title = "Case Abundance",
                                            ...
                                            plotOutput("plot_case_abundance_heatmap", height = "auto", width = "auto")
                                            )
                                   )
                       )
              )
